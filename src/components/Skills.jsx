    ...
    return (
        <section id="skills" className="py-10 bg-gray-800 relative">
            <div className="mt-8 text-gray-100 text-center">
                ...
                <p className="text-gray-400 nt-3 text-lg">My Knowledge</p>
                <div className="flex items-center justify-center mt-12 gap-10 flex-wrap">
                    {skills.map((skill, i) => (
                        <div
                            className="border-2 border-cyan-400 relative min-w-[10rem] max-w-[16rem] bg-gray-900 p-10 rounded-xl group"
                            key={i}
                        >
                            <div
